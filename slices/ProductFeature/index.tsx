  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-3 lg:grid-rows-[auto,auto]">
        ...
        <FadeIn
          className="self start translate-y-16 space-y-6 bg-white/10 p-10 opacity-0 lg:col-start-3 lg:row-start-1"
        ...
        {/* Fragrance */}
        <FadeIn className="animate-in relative translate-y-16 self-end bg-white/10 opacity-0 will-change-transform">
          <PrismicNextImage
